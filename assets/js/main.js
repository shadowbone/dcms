...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f3a970a8", module.exports)
  } else {
    hotAPI.update("_v-f3a970a8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n    <div class=\"row\">\n      <div class=\"col-xs-12\"> \n        <div class=\"row\">\n          <div class=\"widget-box\">\n            <div class=\"widget-header\">\n              <h4 class=\"widget-title\">\n              <i class=\"ace-icon fa fa-database\"></i>\n                {{ message }}\n              </h4>\n            </div>\n            <br>\n            <div class=\"box-header with-border\">\n              <form class=\"form-horizontal no-margin form-filter\">\n                  <div class=\"form-group\">\n                    <div class=\"col-sm-4\">\n                      <label class=\"col-sm-3 control-label no-padding-right\" for=\"form-field-1\"> Email </label>\n                      <div class=\"col-md-9\">\n                        <input type=\"text\" id=\"form-field-1\" class=\"form-control\">\n                      </div>\n                    </div>\n                    <div class=\"col-sm-4\">\n                      <button class=\"btn btn-md btn-white btn-default test-button\">\n                          <i class=\"ace-icon fa fa-search\"></i>\n                            Search\n                      </button>\n                      <button class=\"btn btn-md btn-white btn-default\">\n                          <i class=\"ace-icon fa fa-refresh\"></i>\n                            Refresh\n                      </button>\n                    </div>\n                  </div>\n              </form>\n            </div>\n            <div class=\"hr hr-dotted\"></div>\n            <!-- <div class=\"widget-body\"> -->\n              <div class=\"widget-main\">\n                <div class=\"row\">\n                  <div class=\"col-md-12\">\n                    <div class=\"col-sm-3\">\n                      <button class=\"btn btn-sm btn-success btn-default test-button\" data-target=\"#modal-detail-config\" v-modal-show=\"\" style=\"margin-left:-11px;\" :data-url=\"formadd\">\n                          <i class=\"fa fa-plus\"></i>\n                            Tambah\n                      </button>\n                    </div>\n                    <table id=\"simple-table\" class=\"table  table-bordered table-hover\" data-filter=\".form-filter\" :data-source=\"source\">\n                      <thead>\n                        <tr>\n                          <th class=\"center\">\n                            <input type=\"checkbox\" class=\"ace\">\n                          </th>\n                          <th class=\"detail-col\">Details</th>\n                          <th>Domain</th>\n                          <th>Price</th>\n                          <th class=\"hidden-480\">Clicks</th>\n\n                          <th>\n                            <i class=\"ace-icon fa fa-clock-o bigger-110 hidden-480\"></i>\n                            Update\n                          </th>\n                          <th class=\"hidden-480\">Status</th>\n\n                          <th></th>\n                        </tr>\n                      </thead>\n                      <tbody>\n                      </tbody>\n                    </table>\n                    </div>\n                  </div><!-- /.span -->\n              </div>\n            <!-- </div> -->\n          <!-- </div>       -->\n        </div><!-- PAGE CONTENT ENDS -->\n      </div><!-- /.col -->\n    </div>\n\n    <form-input :data=\"data\"></form-input>\n</div>"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-17efba77", module.exports)
  } else {
    hotAPI.update("_v-17efba77", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./form-input.vue":13,"vue":7,"vue-hot-reload-api":3}],15:[function(require,module,exports){
'use strict';
...
},{"./components/About.vue":10,"./components/App.vue":11,"./components/Home.vue":12,"./components/master/user/index.vue":14,"./vuex/store":16,"vue-resource":4,"vue-router":5,"vue/dist/vue.js":6}],16:[function(require,module,exports){
'use strict';
