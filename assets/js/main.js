...
exports.default = {
  ...
  methods: {
    prepare: function prepare() {
      this.$http.get(HostParent + '/master/barang').then(function (response) {}, function (error) {
...
var router = new _vueRouter2.default({
  ...
  routes: [{ path: '/about', component: _About2.default }, { path: '/home', component: _Home2.default }]
});
...
},{"./components/About.vue":10,"./components/App.vue":11,"./components/Home.vue":12,"./vuex/store":14,"vue-resource":4,"vue-router":5,"vue/dist/vue.js":6}],14:[function(require,module,exports){
'use strict';
