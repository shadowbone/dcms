...
exports.default = {
  ...
  methods: {
    prepare: function prepare() {
      this.$http.get(_HostParent + '/master/barang').then(function (response) {}, function (error) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-984b88f2", module.exports)
  } else {
...
},{"./user/Form.vue":14,"./user/Index.vue":15}],14:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-400cccb6", module.exports)
  } else {
    hotAPI.update("_v-400cccb6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-f44c617e", module.exports)
  } else {
    hotAPI.update("_v-f44c617e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var router = new _vueRouter2.default({
  ...
  routes: [{ path: '/about', component: _About2.default }, { path: '/home', component: indexUser }]
});
...
},{"./components/About.vue":10,"./components/App.vue":11,"./components/Home.vue":12,"./components/master/master":13,"./vuex/store":17,"vue-resource":4,"vue-router":5,"vue/dist/vue.js":6}],17:[function(require,module,exports){
'use strict';
